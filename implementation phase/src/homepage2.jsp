...
<div class="row">
	<div class="col-md-9 col-md-offset-10">
		Hello, <b><%= session.getAttribute( "firstname" )%> <%=session.getAttribute("lastname")%><b>
	...
	<form action="list.jsp">
		<div class="row">
				...
				<label for="source"><b>Source</b></label>
					<input type="text" name="source" class="form-control" id="isource" placeholder="Source" reqiured>
				</div>
		  		<div class="form-group">
				<label for="destination"><b>Destination</b></label>
					<input type="text" name="destination" class="form-control" id="idestination" placeholder="Destination" reqiured>
				</div>
				<div class="form-group">
				<label for="departuredate"><b>Departure Date</b></label>
					<input type="date" min="current_date" name="departuredate" class="form-control" id="idestination" placeholder="Destination" reqiured>
				</div>
			</div>
